"""
file: hershey_simplex.py
version: 1.0
author: Sam Cao
created: 2026-09-05
last_updated: 2026-09-05
description: Vendored Hershey Simplex (futural) single-line glyphs for label text. Public-domain Hershey data, extracted from the MIT-licensed Hershey-Fonts package (see LICENSE_HERSHEY.txt). Coordinates are y-down: cap line at CAP_LINE, baseline at BASE_LINE.
ai_update: Update last_updated and version. Regenerate from the Hershey-Fonts package rather than editing glyphs by hand. Append changelog at bottom.
"""
...
# char: (left_side, right_side, [stroke, ...]); each stroke is a list of (x, y) points, y down.
GLYPHS = {
...
# CHANGELOG
# v1.0 (2026-09-05): Initial release, generated from Hershey-Fonts 2.1.0 futural.
