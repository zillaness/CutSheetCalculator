...
- 03:36 ▶ NEXT: unit 6b, downstream per-sheet sizes: render (reference/cut svg/dxf), verify (boundary + area per sheet), report (per-sheet size), pipeline/webapi, web UI stock list, docs. Then handoff.
